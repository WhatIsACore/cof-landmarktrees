...
function openCard(el) {
    ...
    el.querySelector('.card-content').scrollTo(0, 0);
}
...
$('#attributions-btn').addEventListener('click', e => openCard('#attributions-card'));